var STT = (() => {
  ...
  return function (STT) {
    ...
    var Module = typeof STT != 'undefined' ? STT : {}
    ...
    function createWasm() {
      ...
      function receiveInstance(instance, module) {
        ...
        Module['asm'] = exports
        registerTLSInit(Module['asm']['Eb'])
        wasmTable = Module['asm']['Ab']
        addOnInit(Module['asm']['yb'])
        wasmModule = module
        if (!ENVIRONMENT_IS_PTHREAD) {
    ...
    var PThread = {
      ...
      allocateUnusedWorker: function () {
        var pthreadMainJs = locateFile('stt_wasm.worker.js')
    ...
    function ___syscall_stat64(path, buf) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(13, 1, path, buf)
      try {
        path = SYSCALLS.getStr(path)
    ...
    function ___syscall_unlinkat(dirfd, path, flags) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(14, 1, dirfd, path, flags)
      try {
        path = SYSCALLS.getStr(path)
        path = SYSCALLS.calculateAt(dirfd, path)
        if (flags === 0) {
    ...
    function __msync_js(addr, len, flags, fd) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(16, 1, addr, len, flags, fd)
      try {
        addr >>>= 0
    ...
    function _fd_write(fd, iov, iovcnt, pnum) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(25, 1, fd, iov, iovcnt, pnum)
      try {
        var stream = SYSCALLS.getStreamFromFD(fd)
    ...
    var asmLibraryArg = {
      ...
      Fa: _emscripten_unwind_to_js_event_loop,
      xa: _environ_get,
    ...
    var _malloc = (Module['_malloc'] = function () {
      return (_malloc = Module['_malloc'] = Module['asm']['zb']).apply(
        null,
        arguments
      )
    })
    var _free = (Module['_free'] = function () {
      return (_free = Module['_free'] = Module['asm']['Bb']).apply(
        null,
        arguments
      )
    })
    ...
    var _setThrew = (Module['_setThrew'] = function () {
      return (_setThrew = Module['_setThrew'] = Module['asm']['Ob']).apply(
        null,
        arguments
      )
    })
    ...
    var stackSave = (Module['stackSave'] = function () {
      return (stackSave = Module['stackSave'] = Module['asm']['Qb']).apply(
        null,
        arguments
      )
    })
    ...
    var stackAlloc = (Module['stackAlloc'] = function () {
      return (stackAlloc = Module['stackAlloc'] = Module['asm']['Sb']).apply(
        null,
        arguments
      )
    })
    ...
    var dynCall_jij = (Module['dynCall_jij'] = function () {
      return (dynCall_jij = Module['dynCall_jij'] = Module['asm']['Vb']).apply(
        null,
        arguments
      )
    })
    ...
    var dynCall_iij = (Module['dynCall_iij'] = function () {
      return (dynCall_iij = Module['dynCall_iij'] = Module['asm']['$b']).apply(
        null,
        arguments
      )
    })
    ...
    var dynCall_jii = (Module['dynCall_jii'] = function () {
      return (dynCall_jii = Module['dynCall_jii'] = Module['asm']['cc']).apply(
        null,
        arguments
      )
    })
    var dynCall_vij = (Module['dynCall_vij'] = function () {
      return (dynCall_vij = Module['dynCall_vij'] = Module['asm']['dc']).apply(
        null,
        arguments
      )
    })
    ...
    var dynCall_jji = (Module['dynCall_jji'] = function () {
      return (dynCall_jji = Module['dynCall_jji'] = Module['asm']['gc']).apply(
        null,
        arguments
      )
    })
    ...
    var dynCall_ij = (Module['dynCall_ij'] = function () {
      return (dynCall_ij = Module['dynCall_ij'] = Module['asm']['ic']).apply(
        null,
        arguments
      )
    })
    ...
    var dynCall_iiiijjjii = (Module['dynCall_iiiijjjii'] = function () {
      return (dynCall_iiiijjjii = Module['dynCall_iiiijjjii'] =
    ...
    var dynCall_iji = (Module['dynCall_iji'] = function () {
      return (dynCall_iji = Module['dynCall_iji'] = Module['asm']['uc']).apply(
        null,
        arguments
      )
    })
    var dynCall_jjj = (Module['dynCall_jjj'] = function () {
      return (dynCall_jjj = Module['dynCall_jjj'] = Module['asm']['vc']).apply(
        null,
        arguments
      )
    })
...
else if (typeof exports === 'object') exports['STT'] = STT
